        ...
        <div class="announcement-footer">
          ...
          <div class="footer-right">
            ...
            <button
              ...
              @click="downloadFile(announcement.id, announcement.file_name)"
              class="download-btn"
            >
...
export default {
  ...
  methods: {
    ...
    async fetchAnnouncements() {
      try {
        const response = await axios.get('/api/announcements/?role=teacher', {
    ...
    async downloadFile(announcementId, fileName) {
      try {
        const response = await axios.get(`/api/announcements/${announcementId}/download`, {
          headers: this.getAuthHeaders(),
          responseType: 'blob'
        })
