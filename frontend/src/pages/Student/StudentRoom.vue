    ...
    <div class="hero-section">
      ...
      <div class="hero-content">
        <div class="hero-left">
          ...
          <p class="hero-subtitle">Connect, Learn, and Grow Together</p>
        ...
        <div class="hero-right">
          <div class="student-card">
            ...
            <div class="student-info">
              ...
              <p class="student-grade">{{ getStudentGrade() }}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="daily-motivation">
        ...
        <span class="motivation-text">"Keep going. You're improving every day!"</span>
      </div>
    </div>
        ...
        <div class="search-container">
          <div class="search-wrapper">
            ...
            <input
              v-model="searchQuery"
              type="text"
              placeholder="Search posts, topics, questions..."
          ...
          >
            ...
            <div class="post-header">
              <div class="post-badges">
                ...
                <span v-if="post.user_role === 'teacher'" class="badge teacher">
                  👨‍🏫 Teacher
                </span>
              </div>
            ...
            <div class="post-actions">
              <div class="reactions-group">
                ...
                <button
                  ...
                  :class="['action-btn', { active: post.showComments }]"
                >
        ...
        <form @submit.prevent="submitPost" class="modal-body">
          ...
          <div class="form-group">
            ...
            <textarea
              ...
              rows="8"
              placeholder="Share your questions, knowledge, or thoughts..."
...
export default {
  ...
  data() {
    return {
      ...
      categories: [
        ...
        { value: 'Q&A', label: 'Q&A', icon: '❓', count: 0 },
        { value: 'Study Tips', label: 'Study Tips', icon: '📚', count: 0 },
        { value: 'Exam Advice', label: 'Exam Advice', icon: '📝', count: 0 },
    ...
    filteredPosts() {
      ...
      switch (this.selectedFilter) {
        case 'latest':
          ...
          break;
        case 'unanswered':
          result = result.filter(post => post.comments === 0);
          result.sort((a, b) => new Date(b.date) - new Date(a.date));
          break;
        case 'most_liked':
  ...
  methods: {
    getStudentGrade() {
      ...
      return localStorage.getItem('grade') || 'Grade 10';
    },
    ...
    getProfileImage(profileImage, username) {
      ...
      return `https://api.dicebear.com/7.x/avataaars/svg?seed=${username}&backgroundColor=dbeafe`;
    },
    
    handleImageError(event) {
      event.target.src = `https://api.dicebear.com/7.x/avataaars/svg?seed=${Math.random()}&backgroundColor=dbeafe`;
    },
    ...
    isTrending(post) {
      ...
      return (post.likes > 5 || post.comments > 3) && !post.is_pinned;
    },
      ...
      if (this.userId) {
        forumService.toggleLike(post.id, this.userId).then(result => {
          if (result) {
            ...
            this.updateStats();
            this.showToast(
              result.is_liked ? 'Post liked!' : 'Like removed',
              'success',
              result.is_liked ? '❤️' : '💔'
            );
          }
  ...
  async mounted() {
    ...
    this.currentUserProfileImage = userProfile 
      ...
      : `https://api.dicebear.com/7.x/avataaars/svg?seed=${this.userName}&backgroundColor=dbeafe`;
